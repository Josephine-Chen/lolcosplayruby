...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { author: @guide.author, link: @guide.link, name: @guide.name, type: @guide.type } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { author: @guide.author, link: @guide.link, name: @guide.name, type: @guide.type } }
