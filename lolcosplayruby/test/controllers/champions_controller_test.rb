...
class ChampionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create champion" do
    assert_difference('Champion.count') do
      post champions_url, params: { champion: { adc: @champion.adc, citystate: @champion.citystate, jungle: @champion.jungle, mid: @champion.mid, name: @champion.name, race: @champion.race, sex: @champion.sex, support: @champion.support, top: @champion.top } }
    end
  ...
  test "should update champion" do
    patch champion_url(@champion), params: { champion: { adc: @champion.adc, citystate: @champion.citystate, jungle: @champion.jungle, mid: @champion.mid, name: @champion.name, race: @champion.race, sex: @champion.sex, support: @champion.support, top: @champion.top } }
